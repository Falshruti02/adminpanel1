...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            ...
            <a href="<?php echo base_url('user/register'); ?>" class="small btn btn-primary px-4 py-2"><span class="icon-users"></span> Register</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url(<?php echo base_url('public/asset/images/hero_1.jpg'); ?>);">
        <div class="container">
          <div class="row align-items-center">
              ...
              <div class="owl-slide-3 owl-carousel">
                  <div class="course-1-item">
                    <figure class="thumnail">
                      <a href="course-single.html"><img src="<?php echo base_url('public/upload').'/'.$row->photo; ?>" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3><?php echo $row->heading; ?></h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                     <!--  <h2>How To Create Mobile Apps Using Ionic</h2> -->
                      ...
                      <p class="desc mb-4"><?php echo $row->info; ?></p>
                  ...
                  <div class="course-1-item">
                    ...
                    ?>
                    <figure class="thumnail">
                      <a href="#"><img src="<?php echo base_url('public/upload').'/'.$row->photo; ?>" alt="Image" class="img-fluid" style="height: 180px;"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3><?php echo $row->heading; ?></h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                  ...
                  <div class="course-1-item">
                    ...
                    ?>
                    <figure class="thumnail">
                      <a href="course-single.html"><img src="<?php echo base_url('public/upload').'/'.$row->photo; ?>" alt="Image" class="img-fluid" style="height: 180px;"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3><?php echo $row->heading; ?></h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                  ...
                  <div class="course-1-item">
                    ...
                    ?>
                    <figure class="thumnail">
                      <a href="course-single.html"><img src="<?php echo base_url('public/upload').'/'.$row->photo; ?>" alt="Image" class="img-fluid" style="height: 170px;"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3><?php echo $row->heading; ?></h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
    ...
    <div class="section-bg style-1" style="background-image: url(<?php echo base_url('public/asset/images/about_1.jpg'); ?>);">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
  ...
  <div class="site-section">
        ...
        <div class="owl-slide owl-carousel">
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="<?php echo base_url('public/asset/images/person_1.jpg'); ?>" alt="Image" class="img-fluid mr-3">
              <div>
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="<?php echo base_url('public/asset/images/person_2.jpg'); ?>" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Allison Holmes</h3>
                <span>Designer</span>
              </div>
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="<?php echo base_url('public/asset/images/person_4.jpg'); ?>" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Allison Holmes</h3>
                <span>Designer</span>
              </div>
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="<?php echo base_url('public/asset/images/person_3.jpg'); ?>" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Allison Holmes</h3>
                <span>Designer</span>
              </div>
    ...
    <div class="section-bg style-1" style="background-image: url(<?php echo base_url('public/asset/images/hero_1.jpg'); ?>);">
      <div class="container">
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="post-entry-big">
                  <a href="news-single.html" class="img-link"><img src="<?php echo base_url('public/asset/images/blog_large_1.jpg'); ?>" alt="Image" class="img-fluid"></a>
              ...
              <div class="col-lg-6">
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="<?php echo base_url('public/asset/images/blog_1.jpg'); ?>" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
                ...
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="<?php echo base_url('public/asset/images/blog_2.jpg'); ?>" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url(<?php echo base_url('public/asset/images/bg_1.jpg'); ?>)">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
