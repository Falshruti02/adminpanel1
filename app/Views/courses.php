  ...
  <div class="site-wrap">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                      ...
                      ?>
                        ...
                        <p><a href="<?php echo base_url('user/courses_single'); ?>" class="btn btn-primary rounded-0 px-4">Enroll In This Course</a></p>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    ?>
                        <figure class="thumnail">
                                <a href="course-single.html"><img src="<?php echo base_url('public/upload').'/'.$row->photo; ?>" alt="Image" class="img-fluid" style="height: 160px;"></a>
                        <div class="price">$99.00</div>
                        <div class="category"><h3><?php echo $row->heading; ?></h3></div>  
                        </figure>
                        <div class="course-1-content pb-4">
    ...
    <div class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="<?php echo base_url('public/asset/images/logo.jpg'); ?>" alt="Image" class="img-fluid"></p>
